drop table if exists Towns, Addresses, Projects, EmployeesProjects, Departments, Employees cascade;
...
INSERT INTO EmployeesProjects (employee_id, project_id)
VALUES 
(1, 4),
(1, 24),
(1, 38),
...
INSERT INTO Employees (employee_id, first_name, last_name, middle_name, job_title, department_id, manager_id, hire_date, salary, address_id)
VALUES 
...
ADD CONSTRAINT FK_EmployeesProjects_Employees FOREIGN KEY(employee_id)
REFERENCES Employees(employee_id);

ALTER TABLE EmployeesProjects
ADD CONSTRAINT FK_EmployeesProjects_Projects FOREIGN KEY(project_id)
